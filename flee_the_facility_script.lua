...
SetBtn.Position = UDim2.new(1, -110, 0, 10)  -- Canto superior direito
...
UnlockBtn.Position = UDim2.new(1, -110, 0, 60)  -- Logo abaixo do SET
...
UnlockBtn.MouseButton1Click:Connect(function()
    speedLocked = false
    walkspeedValue = 16
    -- FORÇA a velocidade voltar para 16 IMEDIATAMENTE
    if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") then
