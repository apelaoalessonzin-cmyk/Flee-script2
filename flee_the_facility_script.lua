...
-- MUDANÇA CRÍTICA: PlayerGui ao invés de CoreGui (evita conflito com Delta)
FloatGui.Parent = LocalPlayer:WaitForChild("PlayerGui")

local SetBtn = Instance.new("TextButton")
SetBtn.Size = UDim2.new(0, 110, 0, 50)
SetBtn.Position = UDim2.new(0, 50, 0.45, -25)  -- Meio vertical da tela
...
UnlockBtn.Position = UDim2.new(0, 50, 0.45, 30)  -- Logo abaixo do SET
