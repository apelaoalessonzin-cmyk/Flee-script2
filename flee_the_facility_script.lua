...
SetBtn.Position = UDim2.new(0, 10, 0, 10)  -- Canto superior ESQUERDO
...
UnlockBtn.Position = UDim2.new(0, 10, 0, 60)  -- Logo abaixo do SET
...
SetBtn.MouseButton1Click:Connect(function()
    speedLocked = true
    -- FORÇA a velocidade IMEDIATAMENTE e mantém travado
    local char = LocalPlayer.Character
...
UnlockBtn.MouseButton1Click:Connect(function()
    speedLocked = false
    -- NÃO reseta walkspeedValue! Mantém o valor digitado
    -- Apenas FORÇA a velocidade voltar para 16
    local char = LocalPlayer.Character
    if char and char:FindFirstChild("Humanoid") then
