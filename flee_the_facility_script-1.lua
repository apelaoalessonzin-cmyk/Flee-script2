...
local blockedWords = {"discord", "sirius", "enjoying", "library", "find it at", "server", "join", "invite"}
            ...
            if obj:IsA("TextLabel") or obj:IsA("TextButton") or obj:IsA("ImageButton") then
                ...
                for _, word in pairs(blockedWords) do
                    if text:find(word) then
                        -- Destrói o pai (a notificação inteira)
                        local parent = obj.Parent
                        while parent and parent ~= game.CoreGui do
