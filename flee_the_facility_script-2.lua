...
local function ScanComputers()
    ...
    for _, obj in pairs(game.Workspace:GetDescendants()) do
        if obj.Name == "ComputerTable" and obj:IsA("Model") then
            -- Só cria se NÃO tem ESP E NÃO está completado
            if not ComputerESPObjects[obj] and not CompletedComputers[obj] then
                pcall(function()
                    local hl = Instance.new("Highlight")
                    hl.Adornee = obj
                    ...
                    spawn(function()
                        while ComputerESPObjects[obj] and obj.Parent and ComputerESPEnabled do
                        ...
                        -- Cleanup se ESP foi desativado
                        if not ComputerESPEnabled and ComputerESPObjects[obj] then
                            ComputerESPObjects[obj]:Destroy()
                            ComputerESPObjects[obj] = nil
                        end
                    end)
